...
with col_title:
	#title_color = "#FF4B4B"  # Or use a color picker widget: st.color_picker("Pick a color", "#FF4B4B")
	#st.markdown(f"<h1 style='color: {title_color};'>PJC Textbook Exchange</h1>", unsafe_allow_html=True)
